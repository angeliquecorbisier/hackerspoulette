    ...
    <div class="container">
        ...
        <div class="card mb-4 box-shadow">
            ...
            <div class="card-footer">
                <button class="btn btn-lg btn-block btn-primary">More info</button>
            </div>
        </div>
        <div class="card mb-4 box-shadow">
        ...
        <div class="card mb-4 box-shadow">
            ...
            <p class="card-text">Your tiny, dual-display, desktop&nbsp;computer
                …and robot brains, smart home hub, media centre, networked AI core, factory controller, and much more.</p>
            </div>
            <div class="card-footer">
                <button class="btn btn-lg btn-block btn-primary">More info</button>
            </div>
...
<section>
    ...
    <div class="container">
        ...
        <div class="card mb-4 box-shadow">
            <img class="card-img-top" src="https://www.raspberrypi.org/homepage-9df4b/static/8875c8b45499606103f45bb94a9d1902/7fd5d/94e326f3-1b92-450c-9fd5-23183797d30c_desktop%2Bkit%2Bcontents.jpg" alt="Rasperry Pi 4 desktop Kitp">
            <div class="card-body">
            <h5 class="card-title">Rasperry Pi 4 desktop Kit</h5>
            <p class="card-text">Full desktop computer kit. Just connect to HDMI display(s)</p>
            </div>
